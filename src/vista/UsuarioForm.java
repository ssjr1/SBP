...
public class UsuarioForm extends JPanel {
    ...
    private JTextField txtUsuario, txtNombre, txtApellido, txtEmail, txtDireccion, txtBuscar, txtPassword;
    ...
    private void initComponents() {
        ...
        // **Tabla**
        tableModel = new DefaultTableModel(new String[]{"Usuario", "Contraseña", "Nombre", "Apellido", "Email", "Dirección"}, 0);
